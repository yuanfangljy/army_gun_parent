...
public class DateTool {
    ...
    public static String formatDate6 = "yyyyMMdd";
    /**
     * 将字符串转换成时间
     * @param time
     * @return
    ...
    */
    public static String  cutToString(String time) throws ParseException {
        ...
        if(time.length()==10){
            sdf2 = new SimpleDateFormat(formatDate6);
        }else{
            sdf2 = new SimpleDateFormat(formatDate5);
        }
    ...
    public static void main(String[] args) throws ParseException {
        String s = DateTool.cutToString("2018-10-20");
