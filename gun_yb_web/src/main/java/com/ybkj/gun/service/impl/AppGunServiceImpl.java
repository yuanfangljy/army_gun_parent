...
public class AppGunServiceImpl implements AppGunService {
     ...
     * @Author:       刘家义
     * @CreateDate:   2018/12/10 16:47
     */
    @Override
    public List<AppGun> findOffNormalGun(String gunId) throws Exception {
        return appGunMapper.selectOffNormalGun(gunId);
    }

    /**
     * @Description:  功能描述（枪支离位数）
     * @Author:       刘家义
     * @CreateDate:   2018/12/11 13:51
    */
    @Override
    public Integer findOffNormalGunCount() throws Exception {
        return appGunMapper.selectOffNormalGunCount(1);
    }
    ...
    */
    @Override
    public List<AppGun> findOnLineApp(String appName) throws Exception {
        return appGunMapper.selectOnLineApp(appName);
    }
    ...
    */
    @Override
    public Integer findOnLineAppCount() throws Exception {
        return appGunMapper.selectOnLineAppCount(1);
    }
}
