...
public interface GunLocationService {
    ...
    */
    List<GunLocation> findGunTrajectory(String imei, Integer imeiType, String startTime, String endTime) throws Exception;
     ...
     * @CreateDate:   2018/11/26 19:47
     */
    BaseModel findAppAndGunLocation(String imei) throws Exception;
}
